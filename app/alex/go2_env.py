...
class Go2Env:
    def __init__(self, num_envs, env_cfg, obs_cfg, reward_cfg, command_cfg, show_viewer=False, device="cuda"):
        ...
        dragon = self.scene.add_entity(
            gs.morphs.Mesh(file='meshes/dragon/dragon.obj',
                           pos=[5, 5, 0], fixed=True, scale=0.02, euler=[90, 0, 45]),
        )
        boat = self.scene.add_entity(
            gs.morphs.Mesh(file='meshes/boat/boat.obj',
                           pos=[10, 0, 0], fixed=True, scale=1, euler=[90, 0, 0]),
        )
